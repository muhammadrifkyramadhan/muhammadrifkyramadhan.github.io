document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Dicintai seseorang yang ku pun mencitai" },
        { time: 4, text: "Itu sempurna...." },
        { time: 9, text: "Takkan sia kan dia" },
        { time: 13, text: "Belum tentu ada yang seperti dia" },
        { time: 18, text: "Satu dunia tau aku bahagia" },
        { time: 23, text: "Banyak pasang mata saksinya" },
